...
- **image_picker** / **flutter_email_sender**: camera capture and a pre-filled, pre-attached email compose screen (Send Document tab)
...
3. **Send Document**: `SendDocumentScreen`
